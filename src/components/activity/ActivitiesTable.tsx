...
import { useActivities, formatTime, formatDate, formatDateFull, type ActivityGroup } from '@/hooks/useActivities';
        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-medium text-gray-700 w-20">Time</th>
              <th className="px-4 py-3 text-left font-medium text-gray-700">Category</th>
              <th className="px-4 py-3 text-left font-medium text-gray-700 hidden md:table-cell">Comment</th>
              <th className="px-4 py-3 text-right font-medium text-gray-700 w-16">Actions</th>
            </tr>
          </thead>
    ...
    <>
      <tr className="hover:bg-gray-50 transition-colors">
        ...
        <td className="px-4 py-3">
          <div className="font-medium text-gray-900">{formatDate(group.event_date)}</div>
          <div className="text-xs text-gray-500 hidden sm:block">
            {new Date(group.event_date + 'T00:00:00').toLocaleDateString('hr-HR', { weekday: 'short' })}
          </div>
        </td>
