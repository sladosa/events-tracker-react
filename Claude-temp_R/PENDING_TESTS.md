...
**Zadnji update:** S107c (2026-07-12)
**Detalji testova:** [S107c_tests.md](test-sessions/S107c_tests.md) (novi) + [S107b_tests.md](test-sessions/S107b_tests.md)
...
| T-S107c-3  | `enrich_from_izvoda.py --dry`: ZABA_2024-01 → ~15/18 match report; bez `--dry` puni Izvod kolone        | ⬜      |
| T-S107c-4  | Lanac: pravilo koje matcha SAMO tekst iz `Izvod opis` kolone → red dobije Tip/Podtip                    | ⬜      |
