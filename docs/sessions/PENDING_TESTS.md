...
| ID | Test | Status |
| --- | --- | --- |
| T-S149-1 | Kriv e-mail u koloni G: preview crven, Apply siv; s ispravnim e-mailom *Fix as owner* ažurira, ne dodaje | ⬜ |
...
| T-S149-3 | Structure file bez kolone `HiddenInAdd` ne briše skrivanje; prazna ćelija u postojećoj koloni ga briše | ⬜ |
| T-S149-4 | Nacrt Add Activityja pod ključem s ref-om baze | ✅ S149 — čuvaju automatski testovi (`S121`/`S122` E2E, sabotaža ruši 2/3) |
| T-S149-5 | Pločica: „zadnja promjena salda" umjesto „zadnji zapis" (PROD, nakon deploya) | ⬜ |
